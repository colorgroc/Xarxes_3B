...
enum Cmds {
	WELCOME, NEW_CONNECTION, ACK_NEW_CONNECTION, DISCONNECTION, ACK_DISCONNECTION, PING, PING_LOBBY, ACK_PING, ACK_PING_LOBBY, TRY_POSITION, OK_POSITION, REFRESH_POSITIONS, TRY_COLLISION_OPPONENT, QUI_LA_PILLA, ACK_QUI_LA_PILLA, GAMESTARTED, WINNER, ACK_WINNER, ID_ALREADY_TAKEN, NEW_GAME, JOIN_GAME, PASSWORD_INCORRECT, LOGIN, SIGNUP, ACK_LOGIN, ACK_SIGNUP, OUT, GLOBAL_CHAT, GAME_CHAT, NEW_CONNECTION_LOBBY, DISCONNECTION_LOBBY, ACK_DISCONNECTION_LOBBY, ACK_NEW_CONNECTION_LOBBY, ID_ALREADY_PLAYING, NEW_GAME_CREATED, GAME_DELETED, EXIT_GAME, ACK_EXIT_GAME
};
struct Chat {
	int8_t id;
	std::string nickname;
